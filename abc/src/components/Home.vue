        ...
        <div class="container">
            ...
            <div class="row features">
                <div class="col-sm-6 col-md-4 item">
                    <div class="box">
                        <div class="image-box"><img class="box-image img-responsive" src="https://picsum.photos/600/300/?image=25"></div>
                        <div class="info-box">
                ...
                <div class="col-sm-6 col-md-4 item">
                    <div class="box">
                        <div class="image-box"><img class="box-image img-responsive" src="assets/img/portfolio-1.jpg"></div>
                        <div class="info-box">
                            <h3 class="name">Works everywhere</h3>
                            <p class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu.</p><a class="learn-more" href="#">Learn more »</a></div>
                    </div>
